document.addEventListener('DOMContentLoaded', function() {
    ...
    const produtos = [
        { SKU: '001', Proteina: 'Arroz', Fornecedor: 'Fornecedor 1', QuantKG: 50, UnidadeMedida: 'kg', ValorUnitario: 1, ValorTotal: 50, DataCadastro: '2024-01-01', DataVencimento: '2024-06-01' },
        { SKU: '002', Proteina: 'Feijão', Fornecedor: 'Fornecedor 2', QuantKG: 30, UnidadeMedida: 'kg', ValorUnitario: 1, ValorTotal: 30, DataCadastro: '2024-01-10', DataVencimento: '2024-07-10' },
        { SKU: '003', Proteina: 'Macarrão', Fornecedor: 'Fornecedor 3', QuantKG: 20, UnidadeMedida: 'kg', ValorUnitario: 0.5, ValorTotal: 10, DataCadastro: '2024-02-01', DataVencimento: '2024-08-01' },
        { SKU: '004', Proteina: 'Farinha', Fornecedor: 'Fornecedor 4', QuantKG: 25, UnidadeMedida: 'kg', ValorUnitario: 1, ValorTotal: 25, DataCadastro: '2024-03-01', DataVencimento: '2024-09-01' }
    ];
    ...
    produtos.forEach(produto => {
        ...
        const produtoInfo = `
            <div class="product-info">
                ...
                <div><strong>Proteina:</strong> ${produto.Proteina}</div>
    ...
    downloadPDFButton.addEventListener('click', function() {
        ...
        const doc = new jsPDF();
        doc.text('Relatório de Proteina', 10, 10);
        produtos.forEach((produto, index) => {
            doc.text(`\nProteina ${index + 1}`, 10, 20 + (index * 10));
            doc.text(`SKU: ${produto.SKU}`, 10, 30 + (index * 10));
            doc.text(`Proteina: ${produto.Proteina}`, 10, 40 + (index * 10));
        ...
        doc.save('relatorio-proteina.pdf');
    });
    ...
    downloadExcelButton.addEventListener('click', function() {
        ...
        const wsData = [
            ["SKU", "Proteína", "Fornecedor", "Quantidade (kg)", "Unidade de Medida", "Valor Unitário (kg)", "Valor Total (kg)", "Data de Cadastro", "Data de Vencimento", "Consumir em até", "Retirada em"]
        ];
        produtos.forEach(produto => {
            wsData.push([
                produto.SKU,
